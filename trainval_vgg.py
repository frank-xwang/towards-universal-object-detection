...
def parse_args():
  ...
  parser.add_argument('--save_dir', dest='save_dir',
                      help='directory to save models', default="/home/xuw080/data6/faster-rcnn.pytorch/models",
...
if __name__ == '__main__':
  ...
  if args.dataset == "pascal_voc":
      ...
      args.set_cfgs = ['ANCHOR_SCALES', '[2.72, 3.81, 5.45, 7.64, 10.9, 15.27, 21.8, 26, 32]', 'ANCHOR_RATIOS', '[2]', 'MAX_NUM_GT_BOXES', '20']
      ...
      cfg.dataset = args.dataset
      cfg.imdb_name = args.imdb_name
      cfg.TRAIN.SCALES=(2024,) # up-sampling 2x is the best, we choose 1.6x this time.
      cfg.sample_mode = 'bootstrap' # use bootstrap or ramdom as sampling method
      cfg.VGG_ORIGIN = True # whether use vgg original classification layers
      cfg.TRAIN.USE_ALL_GT = True # choose true if want to exclude all proposals overlap with 'people' larger than 0.3
      cfg.filter_empty = False # whether filter 0 gt images
  ...
  if cfg.fix_bn:
    print("INFO: Fix batch normalization layers")
  else:
    print("INFO: Do not fix batch normalization layers")
  ...
  if args.dataset == 'DOTA':
    ...
    cfg.TRAIN.BATCH_SIZE = 128   # num of rois for training rcnn        
  if args.net == 'vgg16':
    #print('===============', cfg.TRAIN.RPN_BATCHSIZE)
    fasterRCNN = vgg16(imdb.classes, pretrained=True, class_agnostic=args.class_agnostic, rpn_batchsize=cfg.TRAIN.RPN_BATCHSIZE)
  ...
  if args.resume:
    if (args.dataset == "clipart" or args.dataset == "comic" or args.dataset == "watercolor")\
      and not_resume:
      load_name = 'models/vgg16/pascal_voc/faster_rcnn_final.pth'
      args.max_epochs = 19 + args.max_epochs 
    else:
