...
from .cross_domain_eval import voc_eval
...
class cross_domain(imdb):
    def __init__(self, image_set, year, devkit_path=None, datasets=None):
        if cfg.dataset == 'cross_domain':
            imdb.__init__(self, name=datasets + '_' + image_set)
        else:
            imdb.__init__(self, name=cfg.dataset + '_' + image_set)
    ...
    def _get_default_path(self):
        ...
        """
        return os.path.join(cfg.DATA_DIR, self.datasets)
    ...
    def gt_roidb(self):
        ...
        print('cfg.name_list is: ', cfg.name_list)
    ...
    def _load_pascal_annotation(self, index):
        ...
        for ix, obj in enumerate(objs):
            ...
            if class_name not in cfg.name_list:
                cfg.name_list.append(class_name)
